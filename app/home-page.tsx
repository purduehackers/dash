                ...
                <div className="h-[85vh] p-8 flex flex-row justify-between items-center border-solid border-white">
                    <div className="h-full flex flex-col justify-center items-start">
                        ...
                        <div className="w-full flex flex-row justify-start">
                            <Link href="https://id.purduehackers.com/api/authorize?client_id=dashboard&response_type=code">
                                <button className="px-8 py-4 my-4 spray-btn btn1">
                            ...
                            <Link href="https://passport-data-pages.vercel.app/" target="_blank">
                                <button className="px-8 py-4 my-4 ml-8 spray-btn btn1">
