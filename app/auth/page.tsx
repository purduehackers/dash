...
export default function SignInPage() {
  ...
  if (accessToken) {
    return (
      <main className="text-white flex min-h-screen flex-col gap-4 items-center p-24">
    ...
    return (
      <main className="text-white flex min-h-screen flex-col items-center justify-center p-24">
        <a
